            ...
            <form onSubmit={onSubmit}>
...

                {
                    listingDetails?.address && (
                        <GoogleMapContainer longitude={listingDetails.address.longitude} latitude={listingDetails.address.latitude}/>
                    )
                }
                ...
                <input type="file" id="images" name="images" accept="image/png, image/jpg, image/jpeg" onChange={onImageChange} multiple/>
