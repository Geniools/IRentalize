                ...
                <div className="dashboard-container">
                    <div className="dashboard-left-panel">
                        <div className="dashboard-left-panel-header">
                            <div className="dashboard-left-panel-image-container"
                                 onClick={() => navigate(USER_CHANGE_PROFILE_PICTURE_URL)}>
                                <img
                                    src={user.profile?.profile_picture ? user.profile?.profile_picture : "/static/assets/default_avatar_male.png"}
                                    alt="Avatar"/>
                        ...
                        <ul className="dashboard-nav-bar">
                            <li><NavLink className={({isActive}) => isActive ? 'active-link' : ''}
                                         to={USER_DETAILS_URL}>My Details</NavLink></li>
                            <li><NavLink className={({isActive}) => isActive ? 'active-link' : ''} to={USER_POSTS_URL}>My
                                Posts</NavLink></li>
                            <li><NavLink className={({isActive}) => isActive ? 'active-link' : ''}
                                         to={USER_RESERVATION_URL}>My Reservations</NavLink></li>
                            <li><NavLink className={({isActive}) => isActive ? 'active-link' : ''} to={USER_ORDERS_URL}>My
                                Orders</NavLink></li>
                            <li><NavLink className={({isActive}) => isActive ? 'active-link' : ''}
                                         to={USER_RECENTLY_VIEWED_URL}>Recently Viewed</NavLink></li>
                        </ul>
                    </div>
